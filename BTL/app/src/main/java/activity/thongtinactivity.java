...
public class thongtinactivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng diadiem = new LatLng(21.007520, 105.824722);

        mMap.addMarker(new MarkerOptions().position(diadiem).title("Dai Hoc Thuy Loi").snippet("175 Tay Son").icon(BitmapDescriptorFactory.defaultMarker()));

        CameraPosition cameraPosition= new CameraPosition.Builder().target(diadiem).zoom(90).build();
